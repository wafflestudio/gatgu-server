    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='chat', to='article.article')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='participant_profile', to='chat.orderchat')),
        ...
        migrations.AddField(
            ...
            name='participants',
            field=models.ManyToManyField(through='chat.ParticipantProfile', to=settings.AUTH_USER_MODEL),
        ),
        migrations.CreateModel(
            name='ChatMessage',
            fields=[
